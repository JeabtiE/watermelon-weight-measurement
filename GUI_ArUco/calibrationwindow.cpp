...
void CalibrationWindow::updateCamera()
{
    ...
    if(ids.size() > 0)
    {
        ...
        if(markerCenter.size() == 4)
        {
            ...
            ///////////////////////////////////////////////////
            // mapping ตาม layout จริงของคุณ
            ///////////////////////////////////////////////////

            imgPts[0] = markerCenter[2]; // TL
            imgPts[1] = markerCenter[1]; // TR
            imgPts[2] = markerCenter[0]; // BL
            imgPts[3] = markerCenter[3]; // BR

            ///////////////////////////////////////////////////
            // ระยะจริง (mm) marker ห่างกัน 30 cm
            ///////////////////////////////////////////////////
